org  9200h						; BIOS将把引导扇区加载到0:8d00h处，并开始执行
...
img10 db 'You can press the Enter key to return.'
row dw 0,3,4,5,6,7,8,9,10,12	         
number dw 33,39,28,29,36,30,30,30,39,38
image dw img1,img2,img3,img4,img5,img6,img7,img8,img9,img10