...
extrn _do_fork					;声明一个c程序函数
extrn _do_wait					;声明一个c程序函数
extrn _do_exit					;声明一个c程序函数
...
;extrn _pcbStartFlag:near		;声明一个外部变量
extrn _fsFlag:near			    ;声明一个外部变量
...
_Fsprocess proc
	...
	;mov si,offset _fsFlag 
	;mov word ptr[si],2
	mov word ptr[_pcbStartFlag],2

	mov bx,offset adress2
	jmp dword ptr [bx]
    ret
_Fsprocess endp
