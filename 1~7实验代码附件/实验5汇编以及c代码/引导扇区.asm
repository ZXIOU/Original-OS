...
img5 db 3,3,3
img6 db 3
img7 db 'Original OS'	        ; 显示的提示语 
number dw 5,7,9,7,3,1,11
image dw img1,img2,img3,img4,img5,img6,img7
row dw 8,9,10,11,12,13,17
col dw 37,36,35,36,38,39,34
